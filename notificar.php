...
$corpoMensagem = "<b>Nome:</b> ".$txtNome." <br><b>Assunto:</b> ".$txtAssunto." <br><b><h2>Dados<h2></b></br> ".$txtMensagem[0]." <br></br> ".$txtMensagem[1]." <br></br> ".$txtMensagem[2]." <br></br> ".$txtMensagem[3]." <br></br> ".$txtMensagem[4]." <br></br> ".$txtMensagem[5]." <br></br> ".$txtMensagem[6];

//classe do envio de e-mail
require_once("class.phpmailer.php");

define('GUSER', 'jujucastro5555@gmail.com'); 
define('GPWD', 'minhasenha');
